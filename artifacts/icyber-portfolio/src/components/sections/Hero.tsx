  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        {/* landing page hero scenic coastal city dusk landscape Cinque Terre */}
        <img
      ...
      <div className="container relative z-20 mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between gap-12">
        {/* Text Content */}
        <motion.div 
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            ...
            <Link 
              href="/services"
              className="w-full sm:w-auto px-8 py-4 rounded-xl font-semibold bg-white/5 border border-white/10 text-foreground hover:bg-white/10 hover:-translate-y-1 transition-all duration-300 flex items-center justify-center text-center"
            >
              Explore Services
            </Link>
          </div>
        ...
        >
          <div className="relative">
            ...
            <div className="relative w-72 h-96 sm:w-80 sm:h-[420px] rounded-t-full rounded-b-[2rem] overflow-hidden border-4 border-white/10 shadow-2xl glass-panel group">
              <img 
            ...
            >
              ...
              <div>
                <p className="font-bold text-foreground">Available for Work</p>
